...
class SemanticNamingEngine:
    ...
    def suggest_names(
        self, coordinates: Coordinates, context: str = "", top_n: int = 5
    ...
    def suggest_with_multiple_objects(
        self, coordinates: Coordinates, top_verbs: int = 3, top_objects: int = 3
    ...
    def _calculate_similarity(
        self, coords1: Coordinates, coords2: Tuple[float, float, float, float]
    ) -> float:
        """
