...
def verify_tech_debt():
    ...
    for filename in files_to_check:
        ...
        print(f"  Coordinates: L={analysis.coordinates[0]:.2f}, J={analysis.coordinates[1]:.2f}, P={analysis.coordinates[2]:.2f}, W={analysis.coordinates[3]:.2f}")
        ...
        if "error" not in projection:
            ...
            print(f"    Projected Coords: L={projection['projected_coordinates'][0]:.2f}, J={projection['projected_coordinates'][1]:.2f}, P={projection['projected_coordinates'][2]:.2f}, W={projection['projected_coordinates'][3]:.2f}")
