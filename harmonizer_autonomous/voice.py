...
class Voice:
    ...
    def narrate_story(self, story: Story):
        ...
        if story.meaning:
            ...
            conscious_sym = (
                self.SYMBOLS["conscious"] if m.is_conscious else self.SYMBOLS["unconscious"]
            )
        ...
        if story.characters:
            ...
            for char in story.characters:
                if char.meaning:
                    ...
                    sym = (
                        self.SYMBOLS["conscious"]
                        if char.meaning.is_conscious
                        else self.SYMBOLS["unconscious"]
                    )
        ...
        if story.gestures:
            ...
            # Group by phase
            autopoietic = [
                g for g in story.gestures if g.meaning and g.meaning.phase == "AUTOPOIETIC"
            ]
            homeostatic = [
                g for g in story.gestures if g.meaning and g.meaning.phase == "HOMEOSTATIC"
            ]
    ...
    def whisper_meaning(self, meaning: Meaning):
        ...
        self.speak(
            f"{sym} C={meaning.consciousness:.4f} [{meaning.phase}] P={meaning.P:.2f} W={meaning.W:.2f}"
        )
